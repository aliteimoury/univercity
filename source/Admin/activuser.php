            ...
            <ul>
                ...
                <li>📘 امور آموزشی
                    <ul>
                        ...
                        <li><a href="manage_class.php">مدیریت کلاس ها</a></li>
                        <li>موقت است این</li>
            ...
            <div class="d-table">
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM `users` WHERE `Status`='ok'";
                        $res = $conn->query($sql);
                        $i = 1;
                        ...
                        while ($user = $res->fetch_assoc()) {
                            ...
                            echo "<td><form method='POST' action='suspendeduser.php' style='display:inline; margin-left:5px;' onsubmit=\"return confirm('آیا مطمئن هستید؟');\">
                            <input type='hidden' name='userid' value='{$user['id']}'>
                            <input type='hidden' name='location' value='activuser.php'>
                            <button type='submit' class='btn btn-sm btn-outline-primary' name='edit'>تعلیق کردن</button>
                            </form></td>";
